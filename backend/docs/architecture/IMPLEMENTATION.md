...
- [API_CONTRACT.md](../api/API_CONTRACT.md) — Full API specifications
- [FIRESTORE_SCHEMA.md](./FIRESTORE_SCHEMA.md) — Database structure
- [AI_PROMPTS_AND_SPECS.md](../guides/AI_PROMPTS_AND_SPECS.md) — Gemini system prompts & function schemas
- [TEST_CASES_SCENARIOS.md](../api/TEST_CASES_SCENARIOS.md) — 4 demo scenarios to test
